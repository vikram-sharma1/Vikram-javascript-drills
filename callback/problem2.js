...
fs.readFile('./lipsum.txt', "utf-8", (err, data) => {
    if(err){
        ...
        // console.log(data)
            ...
            fs.writeFile(`./writeContent/upperCase${num}.txt`, data.toUpperCase(), (err) => {
                if(err){
                    console.log(err)
                    return
                }
                    ...
                    console.log(`sucessfully converted the file`);
                        ...
                        let datainSen = data.toLowerCase().split('.').join('\n')
                            ...
                            fs.writeFile(`./writeContent/upperCase${num}.txt`,datainSen, "utf-8", (err, data) => {
                                if(err){
                                    console.log(err)
                                    return
                                }
                                    ...
                                    fs.appendFile(`./writeContent/breakSenLowerCase${num}.txt`, datainSen, (err) => {
                                        if(err){
                                            console.log(err)
                                        }
                                        else{
